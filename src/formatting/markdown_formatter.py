"""
Markdown formatting utilities for StockReport MCP Server.
"""
import pandas as pd
import logging
...
def format_df_to_markdown(df: pd.DataFrame, title: str = "", max_rows: int = None) -> str:
    ...
    logger.debug(f"max_rows set to: {max_rows}")
